...
<span class="figcaption_hack">Simple decision tree</span>
...
<span class="figcaption_hack">Splits made by the decision tree.</span>
...
<span class="figcaption_hack">Gini impurity of a node n.</span>
...
<span class="figcaption_hack">Gini Impurity of the root node</span>
...
<span class="figcaption_hack">Sample of Data</span>
...
<span class="figcaption_hack">Decision Tree ROC Curve</span>

<span class="figcaption_hack">Random Forest ROC Curve</span>
...
<span class="figcaption_hack">Single decision tree in random forest.</span>
...
You are the best! Beautifully explained! How about a post on gradient descent or
XGBoost? I haven’t found any brilliant articles/tutorials on those yet. If you
know any, please share? :)

Thanks for the kind words. I have been working with gradient boosting machines
(GBM) a lot lately but haven’t yet written an in-depth explanation article!

The two sources I relied on for an overview of the GBM are:

* https://medium.com/mlreview/gradient-boosting-from-scratch-1e317ae4587dcom/photo/ball-ball-shaped-blur-daylight-269057/))</span>

# An Implementation and Explanation of the Random Forest in Python

## A guide for using and understanding the random forest by building up from a
...
<span class="figcaption_hack">The goal is to divide the data points into their respective classes.</span>
